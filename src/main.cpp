...
const string strMessageMagic = "DuiCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    int64 nSubsidy = nSubsidy = 0.000001 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DuiCoin
    bool fStrictPayToScriptHash = true; // Always active in DuiCoin
...
printf("fgssgsgsdg\r\n");
 ...
 printf("dd----------aa\r\n");
    ...
    if(mapBlockIndex.size()==2998||mapBlockIndex.size()==3498||mapBlockIndex.size()==3998||(mapBlockIndex.size()-3998)%500==0
          )

{
printf("fgssCheckpointsgsgsdg\r\n");
      //  StopNode();
Checkpoints::ResetSyncCheckpoint();
       // StartNode(NULL);
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DuiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
        ...
        if (mapBlockIndex.empty())
        {
            ...
            // Genesis block
            const char* pszTimestamp = "2015-12-21 TickCoin Lives!";
            CTransaction txNew;
            ...
            assert(block.hashMerkleRoot == uint256("029efe9fbabaf4197b7afc2a469394236f34ce10ddf257a895f4180e6846051d"));
